...
void convex()
{
    ...
    // cerr << orientation(O, pts[79999], pts[80000]) << " " << orientation(O, pts[80000], pts[80001]) << endl;
    // cerr << pts[79999].f << " " << pts[79999].s << endl;
    // cerr << pts[80000].f << " " << pts[80000].s << endl;
    // cerr << pts[80001].f << " " << pts[80001].s << endl;
    // if(n == 1000000 && arr[1] == 1) cout << pts[0].f << " " << pts[0].s << endl;
    // essentially these are given to be the minimal values, it's (0, 0)
    // normally you'd calculate the lowest value but we don't need to
